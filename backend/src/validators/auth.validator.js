...
const registerValidator = [
  ...
  body('full_name')
    ...
    .isLength({ max: 50 }).withMessage('Full name must not exceed 50 characters'),
  ...
  body('phone_number')
    .optional()
    .trim()
    .matches(/^[0-9]{10,12}$/).withMessage('Phone number must be 10-12 digits'),

  body('role')
    .optional()
    .isIn(Object.values(STAFF_ROLES)).withMessage('Invalid role'),
];
