...
const createAppointmentValidator = [
  body("real_estate_id")
    .notEmpty().withMessage("Real estate ID is required")
    .isInt({ gt: 0 }).withMessage("Real estate ID must be a positive integer"),
  ...
  body("staff_id")
    ...
    .isInt({ gt: 0 }).withMessage("Staff ID must be a positive integer"),
...
const getAllAppointmentValidator = [
  ...
  query("from_time")
    .optional()
    .isISO8601().withMessage("from_time must be a valid datetime"),

  query("to_time")
    .optional()
    .isISO8601().withMessage("to_time must be a valid datetime"),
];
...
const appointmentIdParamValidator = [
  param("id")
    ...
    .isInt({ gt: 0 }).withMessage("Appointment ID must be a positive integer"),
];
