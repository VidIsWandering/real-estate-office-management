        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="md:col-span-2">
            ...
            <Select onValueChange={setTransactionId}>
              ...
              <SelectContent>
                <SelectItem value="GD001">
                  GD001 - Nguyễn Văn A - Nhà phố Quận 1
                </SelectItem>
                <SelectItem value="GD002">
                  GD002 - Trần Thị B - Căn hộ Quận 7
                </SelectItem>
                <SelectItem value="GD003">
                  GD003 - Lê Văn C - Biệt thự Thủ Đức
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    checked && setContractType("deposit")
                  }
                />
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="md:col-span-2">
            ...
            <Select onValueChange={setLegalStaffId}>
              ...
              <SelectContent>
                <SelectItem value="NV001">
                  NV001 - Attorney Nguyễn Văn A
                </SelectItem>
                <SelectItem value="NV002">
                  NV002 - Attorney Trần Thị B
                </SelectItem>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    checked && setContractStatus("draft")
                  }
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    checked && setContractStatus("pending")
                  }
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    checked && setContractStatus("signed")
                  }
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    checked && setContractStatus("notarized")
                  }
                />
                <Label
                  htmlFor="status-notarized"
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    checked && setContractStatus("liquidated")
                  }
                />
                <Label
                  htmlFor="status-liquidated"
                  className="text-sm font-normal"
                >
                  Liquidated
                </Label>
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    checked && setContractStatus("cancelled")
                  }
                />
                <Label
          ...
          <div className="md:col-span-3 flex justify-center gap-3">
            <Button className="bg-primary text-white px-8">Save</Button>
