...
export function PaymentsFilter({ 
  ...
  const handleFilterChange = (key: keyof PaymentsFilterValues, value: string) => {
    if (onFilterChange) {
  ...
  return (
    <div className="flex items-center justify-between">
      <div className="flex items-center gap-2">
        ...
        <Select value={currentFilters.voucherType} onValueChange={(v) => handleFilterChange("voucherType", v)}>
        ...
        <Select value={currentFilters.paymentMethod} onValueChange={(v) => handleFilterChange("paymentMethod", v)}>
          <SelectTrigger className="w-40">
